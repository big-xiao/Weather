...
public class AirQI_Progress extends View{
    ...
    public AirQI_Progress(Context context) {
        super(context);
        init(null,0);
    }

    public AirQI_Progress(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs,0);
    }

    public AirQI_Progress(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs, int defStyleAttr)
    {
             ...
             airPaint =new Paint(Paint.ANTI_ALIAS_FLAG);//画笔太多了，后期删减
    ...
    public void setSituationstr(String situationstr) {
        this.situationstr = situationstr;
    }
    public void setNumstr(String i)
    {
      numstr=i;
        tmpnum=Integer.parseInt(i);
